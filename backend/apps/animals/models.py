...
class Animal(models.Model):
    ...
    species = models.CharField(max_length=50, choices=AnimalSpecies.choices)
    breed = models.ForeignKey(to=Breed, on_delete=models.SET_NULL, null=True)
    ...
    temperament = ArrayField(
        models.CharField(max_length=100, choices=AnimalTemperament.choices, blank=True),
        default=list,
    )
    ...
    accepts_animals = ArrayField(
        models.CharField(max_length=50, choices=AnimalSpecies.choices, blank=True),
        default=list,
    )
    ...
    shelter = models.ForeignKey(to=Shelter, on_delete=models.CASCADE)
